...
(function(root, factory) {
  ...
  // ---------------------
  //
  // A multi-purpose object to use as a controllers for
  ...
  //
  // App routers can only take one `controllers` object.
  // It is recommended that you divide your controllers
  // objects in to smaller pieces of related functionality
  // and have multiple routers / controllers, instead of
  // just one giant router and controllers.
  //
  ...
  Marionette.AppRouter = Backbone.Router.extend({
    ...
    // method is called on the controllers
    ...
    // specified method on the specified `controllers`.
    ...
    _getController: function() {
      return this.getOption('controllers');
    },
    ...
    _addAppRoute: function(controller, route, methodName) {
      ...
      if (!method) {
        throw new Marionette.Error('Method "' + methodName + '" was not found on the controllers');
      }
